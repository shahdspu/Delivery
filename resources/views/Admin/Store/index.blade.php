                                                    ...
                                                    <tbody>
                                                        @foreach ($stores as $store)
                                                            <tr>
                                                                ...
                                                                <td>{{ $store->name }}</td>
                                                                <td>
                                                                    @foreach ($store->store_catigory as $storeCatigory)
                                                                        <p>#{{ $storeCatigory->catigory->name }}</p>
                                                                    @endforeach
                                                                </td>
                                                                <td>{{ $store->email }}</td>
                                                                <td>{{ $store->type }}</td>
                                                                ...
                                                                <td>
                                                                    <div class="button-group">
                                                                        <form method="GET"
                                                                            action="{{ route('admin.store.edit', $store->id) }}">
                                                                            @csrf
                                                                            <button type="submit"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('admin.store.soft.deletes', $store->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('delete')
                                                                        ...
                                                                        <form
                                                                            action="{{ route('admin.store.edit.location', $store->id) }}"
                                                                            method="GET">
                                                                            @csrf
                                                                            <button type="submit"
                                                                                class="clear-background"><i><svg
