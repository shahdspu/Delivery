                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <h5 class="m-b-10">Discount Code Table</h5>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="button-group">
                                                                        <form method="GET"
                                                                            action="{{ route('admin.discount.code.edit', $discountCode->id) }}">
                                                                            @csrf
                                                                            <button type="submit"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('admin.discount.code.soft.deletes', $discountCode->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('delete')
