                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Update Admin</h5>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <select name="type" class="form-control" required>
                                                                    ...
                                                                    <option value="0"
                                                                        {{ $admin->type === 0 ? 'selected' : '' }}>
                                                                        Delivery Workers</option>
                                                                    <option value="1"
                                                                        {{ $admin->type === 1 ? 'selected' : '' }}>
                                                                        Public</option>
                                                                </select>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <select name="gender" class="form-control" required>
                                                                    ...
                                                                    <option value="1"
                                                                        {{ $admin->gender === 1 ? 'selected' : '' }}>Man
                                                                    </option>
                                                                    <option value="0"
                                                                        {{ $admin->gender === 0 ? 'selected' : '' }}>
                                                                        Woman</option>
