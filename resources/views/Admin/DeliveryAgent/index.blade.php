                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <h5 class="m-b-10">Delivery Agent Table</h5>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="button-group">
                                                                        ...
                                                                        <button class="clear-background" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-text" viewBox="0 0 16 16">
                                                                        ...
                                                                        <form method="GET"
                                                                            action="{{ route('admin.delivery.agent.edit', $deliveryAgent->id) }}">
                                                                            @csrf
                                                                            <button type="submit"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('admin.delivery.agent.soft.deletes', $deliveryAgent->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('delete')
