   ...
   <!-- font-awesome-n -->
   <link rel="stylesheet" type="text/css" href="{{ asset('DashboardAssets/assets/css/font-awesome-n.min.css') }}">
   <link rel="stylesheet" type="text/css" href="{{ asset('DashboardAssets/assets/css/font-awesome.min.css') }}">
   <!-- scrollbar.css -->
   <link rel="stylesheet" type="text/css" href="{{ asset('DashboardAssets/assets/css/jquery.mCustomScrollbar.css') }}">
   <!-- Style.css -->
   ...
   <!-- slimscroll js -->
   <script src="{{ asset('DashboardAssets/assets/js/jquery.mCustomScrollbar.concat.min.js') }} "></script>

   <!-- menu js -->
   <script src="{{ asset('DashboardAssets/assets/js/pcoded.min.js') }}"></script>
   <script src="{{ asset('DashboardAssets/assets/js/vertical/vertical-layout.min.js') }} "></script>

   <script type="text/javascript" src="{{ asset('DashboardAssets/assets/js/script.js') }}"></script>
