                                                    ...
                                                    <tbody>
                                                        @foreach ($products as $product)
                                                            <tr>
                                                                ...
                                                                <td>{{ $product->name }}</td>
                                                                <td>
                                                                    @foreach ($product->product_catigory as $productCatigory)
                                                                        <p>#{{ $productCatigory->catigory->name }}</p>
                                                                    @endforeach
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="button-group">
                                                                        <form method="GET"
                                                                            action="{{ route('store.product.edit', $product->id) }}">
                                                                            @csrf
                                                                            <button type="submit"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('store.product.soft.deletes', $product->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('delete')
